  ...
  return (
    <header className="bg-container-light dark:bg-container-dark/80 sticky top-0 z-50 backdrop-blur-sm border-b border-gray-200 dark:border-gray-800">
      <div className="container mx-auto px-6 py-4">
        ...
        {/* Mobile Menu Overlay */}
        <div
          className={`fixed inset-0 z-50 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl transition-all duration-300 ease-in-out md:hidden flex flex-col ${isMobileMenuOpen ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-full pointer-events-none'
            }`}
        >
          {/* Mobile Header */}
