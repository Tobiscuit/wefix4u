...
export default function CallToAction() {
  return (
    <section className="py-24 relative overflow-hidden" id="contact">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-trusted-blue-900 to-trusted-blue-800 z-0"></div>
      ...
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-trusted-blue-400 rounded-full mix-blend-overlay filter blur-3xl opacity-20 animate-pulse delay-1000"></div>
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <p className="mt-8 text-sm text-blue-200 opacity-80 flex items-center justify-center gap-1">
